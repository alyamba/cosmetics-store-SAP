sap.ui.define(
  ...
  function (BaseController, JSONModel, formatter, Filter, FilterOperator) {
    ...
    return BaseController.extend(
      "cosmeticssapui5.cosmeticssapui5.controller.Worklist",
      {
        formatter: formatter,
        ...
        _mFilters: {
          cheap: [new sap.ui.model.Filter("price", "LT", 50)],
          moderate: [new sap.ui.model.Filter("price", "BT", 50, 100)],
          expensive: [new sap.ui.model.Filter("price", "GT", 100)],
        },
