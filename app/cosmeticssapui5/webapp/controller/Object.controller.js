sap.ui.define(
  ...
  function (BaseController, JSONModel, History, formatter, MessageToast) {
    ...
    return BaseController.extend(
      "cosmeticssapui5.cosmeticssapui5.controller.Object",
      {
        formatter: formatter,
        ...
        onRatingChanged: function (oEvent) {
          var iValue = oEvent.getParameter("value"),
            sMessage = this.getResourceBundle().getText(
        ...
        _onObjectMatched: function (oEvent) {
          ...
          this._bindView("/Cosmetics" + sObjectId);
        },
